...
import { getUserByid, prisma } from './db/operations.js'
...
const getContext = async ({ req }) => {
  // Implement data loader here, to ensure the company data is not cached
  const getCompanyByIdLoader = new DataLoader(async (ids) => {
