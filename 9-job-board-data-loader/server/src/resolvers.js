...
import { createJob, deleteJob, getJobById, getJobByIdAndCompanyId, getJobs, getUserByEmail, updateJob } from './db/operations.js'
...
export const resolvers = {
  ...
  Job: {
    company: (data, __args, { getCompanyByIdLoader }) => getCompanyByIdLoader.load(data.companyId),
